				...
				parameters: {
					...
					properties: {
						...
						suggestedDocumentation: {
							type: 'string',
							description: 'Suggests a more appropriate documentation topic if the question is not relevant to the current documentation. Value can be any of these: "angular, vuejs, reactjs"',
						}
					},
