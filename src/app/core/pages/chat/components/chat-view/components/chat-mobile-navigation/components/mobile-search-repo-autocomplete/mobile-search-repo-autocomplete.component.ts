...
@Component({
  selector: 'app-mobile-search-repo-autocomplete',
  templateUrl: './mobile-search-repo-autocomplete.component.html',
  styles: [
    `
      :host {
        display: block;
...
export class MobileSearchRepoAutocompleteComponent implements OnDestroy {
