...
import { LernService } from 'src/app/core/pages/lern/services/lern.service';
import { Repo } from 'src/app/shared/models/repo.model';

@Component({
  selector: 'app-lern-list',
  templateUrl: './lern-list.component.html',
  styles: [
    `
      :host {
        display: block;
...
export class LernListComponent {
